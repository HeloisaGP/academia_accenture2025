...
Funcionalidade: truckQuote-01 - Envio da Cotação
    Cenário: Envio da cotação com sucesso
        Dado que acesso o portal Tricentis Vehicle Insurance
        E clico na aba Truck
        E preencho com dados válidos do caminhão a Enter Vehicle Data
        E clico no botão next da Enter Vehicle Data
        E preencho com dados válidos do caminhão a Enter Insurant Data
        E clico no botão next da Enter Insurant Data
        E preencho com dados válidos do caminhão a Enter Product Data
        ...
        Quando preencho campos obrigatórios com dados de login válidos
